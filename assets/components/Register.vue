          ...
          <div class="modal-body">
            <form id="registrationForm" @submit.prevent="submitRegistration" autocomplete="off">
              <div class="row">
                <div class="col">
                  <div class="mb-3">
                    <input type="text" required v-model="firstname" class="form-control" placeholder="enter First Name" autocomplete="off" />
                  </div>
                </div>
                <div class="col">
                  <div class="mb-3">
                    <input type="text" required v-model="lastname" class="form-control" placeholder="enter Last Name" autocomplete="off" />
                  </div>
                </div>
              </div>
              <div class="row">
